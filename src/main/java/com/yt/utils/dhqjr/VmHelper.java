...
public class VmHelper {
    ...
    private static final Logger LOGGER = Logger.getLogger(VmHelper.class);

    private static VmHelper instance;
    ...
    public static synchronized VmHelper getInstance() {
        if (instance == null) {
            instance = new VmHelper();
        }
        return instance;
    }
