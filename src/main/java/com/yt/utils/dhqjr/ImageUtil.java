...
public class ImageUtil {
    ...
    private static String[] imageNames = {"bmp", "dib", "gif", "jfif", "jpe",
    ...
    public static String resize(int width, int height, String savePath,
                                Image targetImage) throws IOException {
		...
		/*
         * if (savePath == null || "".equals(savePath)) { savePath =
		 * DEFAULT_FILE_PATH + System.currentTimeMillis() +
     ...
     */
    public static String resize(int width, int height, String savePath,
                                URL targetURL) throws IOException {
